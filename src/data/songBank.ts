...
export const defaultSongBank: Song[] = [
  ...
  {
    id: 110,
    title: "בדרך אליך - נועה קירל ואליעד",
    embedUrl: "https://www.youtube.com/embed/Sn1ra7NIOOo?autoplay=1&controls=0&modestbranding=1&rel=0",
    fullUrl: "https://www.youtube.com/watch?v=Sn1ra7NIOOo"
  }
];

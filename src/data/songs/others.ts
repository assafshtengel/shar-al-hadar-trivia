...
export const otherSongs: Song[] = [
  {
    id: 66,
    title: "יא בינתי - נסרין קדרי",
    embedUrl: "https://www.youtube.com/embed/Rzk7-qOSnSQ?autoplay=1&controls=0&modestbranding=1&rel=0",
    fullUrl: "https://www.youtube.com/watch?v=Rzk7-qOSnSQ"
  },
  {
    id: 67,
    title: "יש לי אותך - איל גולן",

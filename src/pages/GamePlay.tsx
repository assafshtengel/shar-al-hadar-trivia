...
const GamePlay: React.FC = () => {
  ...
  const handleAnswer = async (isCorrect: boolean, selectedIndex: number) => {
    ...
    // If player has already answered, skip the 50/50 phase and go directly to results
    // or if we're already in the final phase, submit all answers
    if (timeLeft <= 0 || isFinalPhase || answeredEarly) {
      console.log("Player answered, skipping 50/50 phase and going to results");
      submitAllAnswers();
    }
  };

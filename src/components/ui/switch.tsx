...
>(({ className, ...props }, ref) => (
  <SwitchPrimitives.Root
    className={cn(
      ...
      "data-[state=checked]:bg-primary/80 data-[state=unchecked]:bg-gray-300 data-[state=unchecked]:opacity-50",
  ...
  >
    <SwitchPrimitives.Thumb
      className={cn(
        "pointer-events-none block h-5 w-5 rounded-full bg-white shadow-md ring-1 ring-gray-200/50 transition-transform",
